...
from agents.communication.inter_agent_communication_agent import InterAgentCommunicationAgent  # Import the new agent
...
from agents.management.orchestration_agent import OrchestrationAgent  # Import the new agent
from agents.miscellaneous.agent_search_agent import AgentSearchAgent
...
class BuilderGPT(Agent):
    def __init__(self, name, prompt, directory):
        ...
        self.search_Agent = AgentSearchAgent(name="AgentSearchAgent")
    ...
    def run_selected_agents(self, agents: List[str], requirements: Dict[str, Any]) -> List[Any]:
        ...
        for agent in agents:
            ...
            agent_code = self.agent_improvement_agent.load_agent_code(f"{agent}_agent.py")
